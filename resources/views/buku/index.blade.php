...
<div class="min-h-full">
    ...
    <main>
        <div class="container mx-auto mt-10">
            <h3 class="text-center text-2xl font-bold mb-4">Data Buku</h3>
            <hr class="mb-6">
            <div class="bg-white shadow-md rounded-lg p-6">
                <a href="{{ route('bukus.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mb-4 inline-block">TAMBAH</a>
                        ...
                        @forelse ($bukus as $buku)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="py-2 px-4 border-b text-center">
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('bukus.destroy', $buku->id) }}" method="POST" class="inline">
                                        <a href="{{ route('buku.edit', $buku->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded">EDIT</a>
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 rounded ml-2">HAPUS</button>
                                    </form>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-red-500 py-4">Data Buku belum Tersedia.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
